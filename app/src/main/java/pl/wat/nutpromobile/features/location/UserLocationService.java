...
public class UserLocationService extends Service implements LocationListener, GpsStatus.Listener {

    public final static String TAG = "Custom: " + UserLocationService.class.getSimpleName();

    private static final long MIN_DISTANCE_CHANGE_FOR_UPDATES = 10; // zmiana co 10 m
    private static final long MIN_TIME_BW_UPDATES = 1000 * 60;    // zmiana co minute
    ...
    public Location setupLocation(Context context) {
        try {
            ...
            if (!locationManagerIsEnabled && networkConnected) {
